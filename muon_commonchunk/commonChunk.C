...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/scratch/klin/MonteCarlo/MC_numu/MC_numu_osccut.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/scratch/klin/MonteCarlo/MC_numu/MC_numu_osccut.root");
      }
