...
// Read contents of entry.
   ...
   std::cout<<"CHECK "<<__FILE__<<" LINE "<<__LINE__<<" for entry "<<entry<<std::endl;
...
void commonChunk::Init(TTree *tree)
{
   ...
   //CHECK, Keng, the followings give errors when running.
...
//   fChain->SetBranchAddress("TOptionalWeightsChunk", &TOptionalWeightsChunk_, &b_TOptionalWeightsChunk_);
//   fChain->SetBranchAddress("TOptionalWeightsChunk.chunk_id_", TOptionalWeightsChunk_chunk_id_, &b_TOptionalWeightsChunk_chunk_id_);
//   fChain->SetBranchAddress("TOptionalWeightsChunk.data_.fUniqueID", TOptionalWeightsChunk_data__fUniqueID, &b_TOptionalWeightsChunk_data__fUniqueID);
//   fChain->SetBranchAddress("TOptionalWeightsChunk.data_.fBits", TOptionalWeightsChunk_data__fBits, &b_TOptionalWeightsChunk_data__fBits);
//   fChain->SetBranchAddress("TOptionalWeightsChunk.data_.oneplate_wgt", TOptionalWeightsChunk_data__oneplate_wgt, &b_TOptionalWeightsChunk_data__oneplate_wgt);
//   fChain->SetBranchAddress("TOptionalWeightsChunk.data_.twoplate_wgt", TOptionalWeightsChunk_data__twoplate_wgt, &b_TOptionalWeightsChunk_data__twoplate_wgt);
//   fChain->SetBranchAddress("TOptionalWeightsChunk.name_", TOptionalWeightsChunk_name_, &b_TOptionalWeightsChunk_name_);
