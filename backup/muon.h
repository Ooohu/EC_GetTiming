...
// Thu May 18 17:04:21 2017 by ROOT version 6.06/06
// from TTree MiniBooNE/Created in /scratch/condor-tmp/echuang/data_root_files/data_numu_ntuple_161219_abs0///data_numu_ntuple_161219_abs0_0.root
// found on file: data_numu_ntuple_161219.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   const Int_t kMaxTHistory = 89;
   const Int_t kMaxTHistory_algo_name = 89;
   const Int_t kMaxTHistory_algo_inst = 89;
   const Int_t kMaxTHistory_chunk_name = 89;
   const Int_t kMaxTHistory_ext_name = 89;
   const Int_t kMaxTHistory_version = 89;
   const Int_t kMaxTHistory_node = 89;
   const Int_t kMaxTHistory_database = 89;
   const Int_t kMaxTHistory_inst_num = 89;
   const Int_t kMaxTHistory_timestamp = 89;
   const Int_t kMaxTHistory_rcpid = 89;
   const Int_t kMaxTHistory_chunkid = 89;
   const Int_t kMaxTHistory_parents = 89;
   const Int_t kMaxTHistory_tags = 89;
   ...
   const Int_t kMaxTCalibratedMWRChunk = 3;
   const Int_t kMaxTCalibratedMWRChunk_chunk_id = 3;
   const Int_t kMaxTCalibratedMWRChunk_name = 3;
   const Int_t kMaxTGlobalTankHeaderChunk = 1;
   const Int_t kMaxTGlobalTankHeaderChunk_chunk_id = 1;
   const Int_t kMaxTGlobalTankHeaderChunk_name = 1;
   ...
   const Int_t kMaxTCalibratedDataChunk = 1;
   const Int_t kMaxTCalibratedDataChunk_chunk_id = 1;
   const Int_t kMaxTCalibratedDataChunk_name = 1;
   const Int_t kMaxTCrate13Chunk = 1;
   const Int_t kMaxTCrate13Chunk_chunk_id = 1;
   const Int_t kMaxTCrate13Chunk_name = 1;
   const Int_t kMaxTConnectTheHitsChunk = 1;
   const Int_t kMaxTConnectTheHitsChunk_chunk_id = 1;
   const Int_t kMaxTConnectTheHitsChunk_name = 1;
   const Int_t kMaxTVetoClusterChunk = 1;
   const Int_t kMaxTVetoClusterChunk_chunk_id = 1;
   const Int_t kMaxTVetoClusterChunk_name = 1;
   ...
   const Int_t kMaxTParticleIDChunk = 18;
   const Int_t kMaxTParticleIDChunk_chunk_id = 18;
   const Int_t kMaxTParticleIDChunk_name = 18;
   const Int_t kMaxTTwoTrackChunk = 1;
   const Int_t kMaxTTwoTrackChunk_chunk_id = 1;
   const Int_t kMaxTTwoTrackChunk_name = 1;
   const Int_t kMaxTTwoTrackPredictionsChunk = 1;
   const Int_t kMaxTTwoTrackPredictionsChunk_chunk_id = 1;
   const Int_t kMaxTTwoTrackPredictionsChunk_name = 1;
   const Int_t kMaxTTwoTrackEndConditionsChunk = 1;
   const Int_t kMaxTTwoTrackEndConditionsChunk_chunk_id = 1;
   const Int_t kMaxTTwoTrackEndConditionsChunk_name = 1;
   const Int_t kMaxTTwoTrackInternalsChunk = 1;
   const Int_t kMaxTTwoTrackInternalsChunk_chunk_id = 1;
   const Int_t kMaxTTwoTrackInternalsChunk_name = 1;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data_numu_ntuple_161219.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data_numu_ntuple_161219.root");
      }
